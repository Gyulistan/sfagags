...
NDefines.NGame.START_DATE = "1926.7.1.1"
NDefines.NGame.END_DATE = "2191.12.31.1"
NDefines.NDiplomacy.VOLUNTEERS_DIVISIONS_REQUIRED = 8 		-- Vanilla is 30
NDefines.NDiplomacy.TENSION_TIME_SCALE_START_DATE = "1900.1.1.12"	-- Starting at this date, the tension values will be scaled down (will be equal to 1 before that)
